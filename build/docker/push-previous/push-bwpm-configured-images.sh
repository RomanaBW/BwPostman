...
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-push-previous-joomla universe3:5000/romana/bwpm-configured-files:7.4.0-4.4.13
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-push-previous-db universe3:5000/romana/bwpm-configured-tables:7.4.0-4.4.13
...
docker push universe3:5000/romana/bwpm-configured-files:7.4.0-4.4.13
docker push universe3:5000/romana/bwpm-configured-tables:7.4.0-4.4.13
