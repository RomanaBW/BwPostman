...
class PlgSystemBWPM_User2Subscriber extends JPlugin
{
	...
	protected function processNewsletterFormatField()
	{
		...
		$this->form->setFieldAttribute('emailformat', 'default', $com_params->get('default_emailformat', '0'), $this->group);
	...
	protected function getDisclaimerLink()
	{
		...
		if ($this->params->get('disclaimer', '0') && $com_params->get('disclaimer', '0'))
		{
			...
			if ($com_params->get('disclaimer_selection', '1') == 1 && $com_params->get('article_id', '0') > 0)
			{
				...
				$disclaimer_link = Route::_(Uri::base() . ContentHelperRoute::getArticleRoute($com_params->get('article_id', '0') . $tpl_com, 0));
			}
