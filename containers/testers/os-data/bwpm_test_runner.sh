...
codecept run acceptance Backend/Lists/TestNewslettersListsCest::FilterSentNewslettersByStatus  ${BW_TEST_DEBUG} --xml xmlreports/report_newsletters_filter_sent_by_statos.xml --html htmlreports/report_newsletters_filter_sent_by_status.html
