...
class SubscriberviewPage
{
	 ...
	 * @since 2.0.0
	 */
	public static $register_edit_url    = "//*/p[contains(@class, 'user_edit')]/a";
	 ...
	 * @since 2.0.0
	 */
	public static $disclaimer    = "//*/input[@id='agreecheck']";
	 ...
	 * @since 3.0.2
	 */
	public static $disclaimer_modal_identifier    = "//*/div[@id='DisclaimerModal']/div[contains(@class,'modal-body')]";
	 ...
	 * @since 3.0.2
	 */
	public static $disclaimer_article_text    = "This module provides search using the Smart Search component.";
	 ...
	 * @since 3.0.2
	 */
	public static $disclaimer_menuitem_text    = "It's easy to get started creating your website. Knowing some of the basics will help. ";
     ...
     * @since 3.2.3
     */
    public static $logoutButton    = "//*/button[@type='submit']";
