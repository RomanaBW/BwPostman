...
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-push-current-joomla universe3:5000/romana/bwpm-configured-files:8.1.0-5.3.4
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-push-current-db universe3:5000/romana/bwpm-configured-tables:8.1.0-5.3.4
...
docker push universe3:5000/romana/bwpm-configured-files:8.1.0-5.3.4
docker push universe3:5000/romana/bwpm-configured-tables:8.1.0-5.3.4
