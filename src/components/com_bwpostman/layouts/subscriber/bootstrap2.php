...
<div class="contentpane mb-3<?php echo $params->get('pageclass_sfx'); ?>">
	...
	if ($params->get('show_gender') == 1)
	{
		...
		$class = $formclass === 'sm' ? 'input-small' : 'input-medium';
    ?>
	...
	{ ?>
		<div class="lists <?php echo $params->get('pageclass_sfx'); ?>">
			<?php
						...
						<div class="mailinglist-description-single">
							...
							if (strlen(Text::_($lists['available_mailinglists'][0]->description)) > $descLength)
							{
								...
								echo HtmlHelper::tooltip(Text::_($lists['available_mailinglists'][0]->description),
									$lists['available_mailinglists'][0]->title, '', '<i class="icon-info"></i>', '');
							} ?>
						</div>
						<?php
					}
