...
class ModuleOverviewCest
{
	...
	public function setupOverviewModule(AcceptanceTester $I)
	{
		...
		$I->clickSelectList(InstallationPage::$published_list, InstallationPage::$published_published, InstallationPage::$published_list_id);
		...
		$I->clickSelectList(InstallationPage::$menuAssignment_list, InstallationPage::$menuAssignment_All, InstallationPage::$menuAssignment_list_id);
