...
class OptionsPage
{
	...
	*/
	...
	public static $bwpm_group_permissions = array(  'BwPostmanAdmin'
											...
											'BwPostmanPublisher'
	                                                => array(
	                                                	'core.admin' => 'Not Allowed (Inherited)',
		                                                'core.login.admin' => 'Allowed (Inherited)',
		                                                'core.manage' => 'Allowed (Inherited)',
		                                                'bwpm.create' => 'Allowed (Inherited)',
		                                                'bwpm.edit' => 'Allowed (Inherited)',
		                                                ...
		                                                'bwpm.view.maintenance' => 'Not Allowed (Inherited)',
												),
											        'BwPostmanEditor'
	                                                => array(
	                                                	'core.admin' => 'Not Allowed (Inherited)',
		                                                ...
		                                                'bwpm.archive' => 'Not Allowed (Inherited)',
		                                                'bwpm.restore' => 'Not Allowed (Inherited)',
		                                                'bwpm.delete' => 'Not Allowed (Inherited)',
		                                                ...
		                                                'bwpm.view.mailinglist' => 'Allowed (Inherited)',
		                                                'bwpm.view.template' => 'Allowed (Inherited)',
		                                                'bwpm.view.archive' => 'Not Allowed (Inherited)',
		                                                'bwpm.admin.newsletter' => 'Not Allowed (Inherited)',
		                                                'bwpm.admin.subscriber' => 'Not Allowed (Inherited)',
		                                                'bwpm.admin.campaign' => 'Not Allowed (Inherited)',
		                                                'bwpm.admin.mailinglist' => 'Not Allowed (Inherited)',
		                                                'bwpm.admin.template' => 'Not Allowed (Inherited)',
		                                                'bwpm.view.maintenance' => 'Not Allowed (Inherited)',
												        ),
											        'BwPostmanCampaignAdmin'
	                                                => array(
	                                                ...
	                                                => array(
												        ...
												        'bwpm.restore' => 'Not Allowed',
												        'bwpm.delete' => 'Not Allowed',
												        'bwpm.send' => 'Not Allowed (Inherited)',
												        'bwpm.view.newsletter' => 'Not Allowed (Inherited)',
												        'bwpm.view.subscriber' => 'Not Allowed (Inherited)',
												        'bwpm.view.campaign' => 'Allowed (Inherited)',
												        'bwpm.view.mailinglist' => 'Not Allowed (Inherited)',
												        'bwpm.view.template' => 'Not Allowed (Inherited)',
												        'bwpm.view.archive' => 'Not Allowed',
												        'bwpm.admin.newsletter' => 'Not Allowed (Inherited)',
												        'bwpm.admin.subscriber' => 'Not Allowed (Inherited)',
												        'bwpm.admin.campaign' => 'Not Allowed',
	                                                ...
	                                                => array(
		                                                ...
		                                                'bwpm.view.newsletter' => 'Not Allowed (Inherited)',
		                                                'bwpm.view.subscriber' => 'Not Allowed (Inherited)',
		                                                'bwpm.view.campaign' => 'Not Allowed (Inherited)',
		                                                'bwpm.view.mailinglist' => 'Allowed (Inherited)',
		                                                'bwpm.view.template' => 'Not Allowed (Inherited)',
		                                                'bwpm.view.archive' => 'Not Allowed',
		                                                'bwpm.admin.newsletter' => 'Not Allowed (Inherited)',
	...
	public static function saveDefaults(\AcceptanceTester $I)
	{
		...
		$I->see("Message", Generals::$alert_success4);
