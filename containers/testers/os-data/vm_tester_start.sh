...
codecept run acceptance User2Subscriber/User2SubscriberCest::activateUser2Subscriber ${DEBUG} --env shop--xml xmlreports/report_user2Subscriber_activate.xml --html htmlreports/report_user2Subscriber_activate.html
...
#codecept run acceptance Backend/TestInstallationCest::activateBuyer2Subscriber ${DEBUG} --env shop--xml xmlreports/report_installation_activate_u2s.xml --html htmlreports/report_installation_activate_u2s.html
...
codecept run acceptance Buyer2Subscriber/Buyer2SubscriberCest::Buyer2SubscriberFunctionWithoutSubscription ${DEBUG} --env shop--xml xmlreports/report_b2s_no_subscription.xml --html htmlreports/report_b2s_no_subscription.html
fi
