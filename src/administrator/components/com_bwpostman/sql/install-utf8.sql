...
CREATE TABLE IF NOT EXISTS `#__bwpostman_newsletters` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `asset_id` INT(10) NOT NULL DEFAULT '0',
  `from_name` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `from_email` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `reply_email` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `template_id` INT(11) NOT NULL DEFAULT '0',
  `text_template_id` INT(11) NOT NULL DEFAULT '0',
  `campaign_id` INT(11) NOT NULL DEFAULT '0',
  `usergroups` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `selected_content` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `subject` VARCHAR(750) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
	`description` VARCHAR(1500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `access` INT(11) NOT NULL DEFAULT '0',
  `attachment` VARCHAR(750) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `intro_headline` VARCHAR(750) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `intro_text` TEXT COLLATE utf8mb4_unicode_ci NOT NULL,
  `intro_text_headline` VARCHAR(750) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_sendmailcontent` (
  ...
  `cc_email` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `bcc_email` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `attachment` TEXT COLLATE utf8mb4_unicode_ci NOT NULL,
  `reply_email` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `reply_name` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `substitute_links` TINYINT(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`,`mode`)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_sendmailqueue` (
  ...
  `recipient` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `mode` INT(1) NOT NULL DEFAULT '0',
  `name` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_subscribers` (
  ...
  `name` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `firstname` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `email` VARCHAR(240) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `emailformat` TINYINT(1) NOT NULL DEFAULT '1',
  `gender` TINYINT(1) unsigned NULL,
  `special` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `status` INT(1) NOT NULL DEFAULT '0',
  `activation` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `editlink` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `access` INT(11) NOT NULL DEFAULT '0',
  `registration_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `registered_by` INT(11) NOT NULL DEFAULT '0',
  `registration_ip` VARCHAR(117) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `confirmation_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `confirmed_by` INT(11) NOT NULL DEFAULT '0',
  `confirmation_ip` VARCHAR(117) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `modified_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_by` INT(10) unsigned NOT NULL DEFAULT '0',
  `checked_out` INT(11) NOT NULL DEFAULT '0',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_templates` (
  ...
  `title` VARCHAR(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` VARCHAR(1500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `thumbnail` VARCHAR(1500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `basics` VARCHAR(2000) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `header` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `intro` TEXT COLLATE utf8mb4_unicode_ci NOT NULL,
  `article` TEXT COLLATE utf8mb4_unicode_ci NOT NULL,
  `footer` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `button1` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `button2` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `button3` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `button4` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `button5` VARCHAR(1200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `access` INT(11) NOT NULL DEFAULT '0',
  `published` TINYINT(1) NOT NULL DEFAULT '0',
  `created_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by` INT(10) unsigned NOT NULL DEFAULT '0',
