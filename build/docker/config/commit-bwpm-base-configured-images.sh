...
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-web universe3:5000/romana/bwpm-base-files-$PHP_VERSION:latest
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-db universe3:5000/romana/bwpm-base-tables-$PHP_VERSION:latest
