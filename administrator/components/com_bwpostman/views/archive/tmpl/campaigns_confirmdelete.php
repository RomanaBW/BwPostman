...
<script type="text/javascript">
	/* <![CDATA[ */
      ...
      htmlText += '			<tr>';
        ...
        htmlText += '					<input type="button" name="submitbutton" onClick="window.parent.confirmDelete(\'1\');"	value="<?php echo JText::_("COM_BWPOSTMAN_YES");?>" />';
        htmlText += '					<input type="button" name="submitbutton" onClick="window.parent.confirmDelete(\'0\');"	value="<?php echo JText::_("COM_BWPOSTMAN_NO");?>" />';
        htmlText += '				</td>';
      }
      htmlText += '			</tr>';
      htmlText += '		</table>';
