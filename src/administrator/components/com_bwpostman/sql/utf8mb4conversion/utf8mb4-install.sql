...
CREATE TABLE IF NOT EXISTS `#__bwpostman_templates` (
  ...
  `tpl_html` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_css` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_article` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_divider` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  ...
  `intro` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `article` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_templates_tags` (
  ...
  `tpl_tags_head_advanced` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_tags_body` TINYINT(1) NOT NULL,
  `tpl_tags_body_advanced` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_tags_article` TINYINT(1) NOT NULL,
  `tpl_tags_article_advanced_b` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_tags_article_advanced_e` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_tags_readon` TINYINT(1) NOT NULL,
  `tpl_tags_readon_advanced` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_tags_legal` TINYINT(1) NOT NULL,
  `tpl_tags_legal_advanced_b` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
  `tpl_tags_legal_advanced_e` TEXT COLLATE utf8mb4_unicode_ci  DEFAULT '',
