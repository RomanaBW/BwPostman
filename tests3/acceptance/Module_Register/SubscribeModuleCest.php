...
class SubscribeModuleCest
{
	...
	public function setupRegistrationModule(AcceptanceTester $I)
	{
		...
		$I->clickAndWait(InstallationPage::$publishedField, 1);
		$I->clickAndWait(InstallationPage::$publishedValue, 1);

		// Fill menu assignment tab
		$I->click(InstallationPage::$registrationTabs['Menu Assignment']);
		$I->waitForElement(InstallationPage::$menuAssignmentField);

		$I->clickAndWait(InstallationPage::$menuAssignmentField, 1);
		$I->clickAndWait(InstallationPage::$menuAssignmentValue, 1);

		$I->click(Generals::$toolbar['Save & Close']);
		$I->waitForElement(Generals::$alert_success, 5);
...
//		$I->see('Error', SubsView::$errorContainerHeader);
	...
	private function subscribeByModule(AcceptanceTester $I, $modal = 'none')
	{
		...
		{
			$I->scrollTo(Helper::$module_position, 0, -100);
			$I->see('Newsletter Registration', Helper::$module_button_module);
			$I->click(Helper::$module_button_module);
