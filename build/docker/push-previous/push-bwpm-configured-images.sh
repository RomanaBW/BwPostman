...
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-push-previous-joomla universe3:5000/romana/bwpm-configured-files:8.1.0-5.4.3
docker commit -a 'Romana Boldt info@boldt-webservice.de' bwpm-push-previous-db universe3:5000/romana/bwpm-configured-tables:8.1.0-5.4.3
...
docker push universe3:5000/romana/bwpm-configured-files:8.1.0-5.4.3
docker push universe3:5000/romana/bwpm-configured-tables:8.1.0-5.4.3
