...
ALTER TABLE `#__bwpostman_campaigns` MODIFY `created_date` DATETIME;
...
ALTER TABLE `#__bwpostman_mailinglists` MODIFY `created_date` DATETIME;
...
ALTER TABLE `#__bwpostman_newsletters` MODIFY `created_date` DATETIME;
...
ALTER TABLE `#__bwpostman_subscribers` MODIFY `registration_date` DATETIME;
...
ALTER TABLE `#__bwpostman_templates` MODIFY `created_date` DATETIME;
