 ...
 *
 * BwPostman newsletter all bootstrap4 template for frontend.
 *
...
<div id="bwpostman">
						...
						<?php if ($this->params->get('filter_field', '1') != "hide") : ?>
							...
							<div class="btn-wrapper input-group">
								...
								<div class="input-group-append">
									...
									<button type="button" class="btn btn-secondary hasTooltip reset"
						...
						<div class="search_right2 text-right clearfix">
							...
							{ ?>
									<?php echo HtmlHelper::_(
										...
										$this->mailinglists,
										'filter.mailinglist',
										'class="inputbox mb-2 filter-mailinglist"',
										'id',
										'title',
	...
	//							$this->state->set('filter.mailinglist', '');
							...
							<?php if ($this->params->get('groups_filter_enable', '1') != 'hide' && is_array($this->usergroups) && count($this->usergroups) > 2) : ?>
									<?php echo HtmlHelper::_(
										'select.genericlist',
										$this->usergroups,
										'filter.usergroup',
										'class="inputbox mb-2 filter-usergroup"',
										'id',
										'title',
							...
							<?php if ($this->params->get('cam_filter_enable', '1') != 'hide' && is_array($this->campaigns) && count($this->campaigns) > 2) : ?>
									<?php echo HtmlHelper::_(
										...
										$this->campaigns,
										'filter.campaign',
										'class="inputbox mb-2 filter-campaign"',
										'id',
										'title',
