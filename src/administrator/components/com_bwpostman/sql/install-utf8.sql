...
CREATE TABLE IF NOT EXISTS `#__bwpostman_newsletters` (
  ...
  `from_email` VARCHAR(240) NOT NULL DEFAULT '',
  `reply_email` VARCHAR(240) NOT NULL DEFAULT '',
  `template_id` INT(11) NOT NULL DEFAULT '0',
  `text_template_id` INT(11) NOT NULL DEFAULT '0',
  `campaign_id` INT(11) NOT NULL DEFAULT '0',
  `usergroups` VARCHAR(300) NOT NULL DEFAULT '',
  `selected_content` VARCHAR(300) NOT NULL DEFAULT '',
  `subject` VARCHAR(750) NOT NULL DEFAULT '',
	`description` VARCHAR(1500) NOT NULL DEFAULT '',
  `access` INT(11) NOT NULL DEFAULT '0',
  `attachment` VARCHAR(750) NOT NULL DEFAULT '',
  `intro_headline` VARCHAR(750) NOT NULL DEFAULT '',
  `intro_text` TEXT NOT NULL,
  `intro_text_headline` VARCHAR(750) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_sendmailcontent` (
  ...
  `cc_email` VARCHAR(240) NOT NULL DEFAULT '',
  `bcc_email` VARCHAR(240) NOT NULL DEFAULT '',
  `attachment` TEXT NOT NULL,
  `reply_email` VARCHAR(240) NOT NULL DEFAULT '',
  `reply_name` VARCHAR(300) NOT NULL DEFAULT '',
  `substitute_links` TINYINT(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`,`mode`)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_sendmailqueue` (
  ...
  `recipient` VARCHAR(240) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_subscribers` (
  ...
  `special` VARCHAR(300) NOT NULL DEFAULT '',
  `status` INT(1) NOT NULL DEFAULT '0',
  `activation` VARCHAR(300) NOT NULL DEFAULT '',
  `editlink` VARCHAR(300) NOT NULL DEFAULT '',
  `access` INT(11) NOT NULL DEFAULT '0',
  `registration_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `registered_by` INT(11) NOT NULL DEFAULT '0',
  `registration_ip` VARCHAR(117) NOT NULL DEFAULT '',
  `confirmation_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `confirmed_by` INT(11) NOT NULL DEFAULT '0',
  `confirmation_ip` VARCHAR(117) NOT NULL DEFAULT '',
  `modified_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_by` INT(10) unsigned NOT NULL DEFAULT '0',
  `checked_out` INT(11) NOT NULL DEFAULT '0',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__bwpostman_templates` (
  ...
  `title` VARCHAR(300) NOT NULL DEFAULT '',
  `description` VARCHAR(1500) NOT NULL DEFAULT '',
  `thumbnail` VARCHAR(1500) NOT NULL DEFAULT '',
  ...
  `basics` VARCHAR(300) NOT NULL DEFAULT '',
  `header` VARCHAR(1200) NOT NULL DEFAULT '',
  `intro` TEXT NOT NULL,
  `article` TEXT NOT NULL,
  `footer` VARCHAR(1200) NOT NULL DEFAULT '',
  `button1` VARCHAR(1200) NOT NULL DEFAULT '',
  `button2` VARCHAR(1200) NOT NULL DEFAULT '',
  `button3` VARCHAR(1200) NOT NULL DEFAULT '',
  `button4` VARCHAR(1200) NOT NULL DEFAULT '',
  `button5` VARCHAR(1200) NOT NULL DEFAULT '',
  `access` INT(11) NOT NULL DEFAULT '0',
  `published` TINYINT(1) NOT NULL DEFAULT '0',
  `created_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by` INT(10) unsigned NOT NULL DEFAULT '0',
