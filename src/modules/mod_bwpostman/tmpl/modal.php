 ...
 *
 * BwPostman small modal template for module.
 *
...
$wa->registerAndUseStyle('mod_bwpostman.bwpm_register_modal');
$wa->registerAndUseScript('mod_bwpostman.bwpm_register_modal');
...
<div id="mod_bwpostman">
	...
	<button id="bwp_reg_open" type="button" class="btn">
		<?php echo Text::_(
				$lang->hasKey('MOD_BWPOSTMAN_MODAL_BTN')
