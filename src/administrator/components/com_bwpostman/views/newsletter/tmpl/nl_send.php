...
?>
	...
	<div id="sendResult" class="j3 mb-2">
		<div class="row-fluid">
			<div class="span12 text-center mb-2">
				<h1><?php echo JText::_('COM_BWPOSTMAN_NL_SENDMAIL'); ?></h1>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6 inner">
				<div class="well">
					<h2><?php echo JText::_('JSTATUS'); ?></h2>
					...
					<div id="sending" class="alert alert-success">
						<strong><?php echo JText::_('COM_BWPOSTMAN_NL_SENDING_PROCESS'); ?></strong>
					</div>
					...
					<div id="complete" class="alert alert-secondary">
						...
						<strong><?php echo JText::_('COM_BWPOSTMAN_NL_QUEUE_COMPLETED'); ?></strong>
					</div>
					<div id="published" class="alert alert-secondary">
						<i class="icon-ok icon-lg"></i>&nbsp;&nbsp;
						<strong><?php echo JText::_('COM_BWPOSTMAN_NLS_N_ITEMS_PUBLISHED_1'); ?></strong>
					</div>
					<div id="nopublished" class="alert alert-secondary">
						<i class="icon-remove icon-lg"></i>&nbsp;&nbsp;
						<strong><?php echo JText::_('COM_BWPOSTMAN_NLS_N_ITEMS_PUBLISHED_0'); ?></strong>
					</div>
					<div id="error" class="alert alert-secondary">
						<i class="icon-remove icon-lg"></i>&nbsp;&nbsp;
						<strong><?php echo JText::_('JERROR_AN_ERROR_HAS_OCCURRED'); ?></strong>
					</div>
				</div>
			</div>
			<div class="span6">
				<div class="well">
					<h2><?php echo JText::_('COM_BWPOSTMAN_NL_SENDING_DETAILS'); ?></h2>
	...
	<input type="hidden" id="startUrl" value="index.php?option=com_bwpostman&task=newsletter.startsending&format=json&<?php echo JSession::getFormToken(); ?>=1" />
	<input type="hidden" id="delay" value="<?php echo $this->delay; ?>" />

<?php
JFactory::getDocument()->addScript(JUri::root(true) . '/administrator/components/com_bwpostman/assets/js/bwpm_j3_nl_send.js');
