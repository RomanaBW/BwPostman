...
ALTER TABLE `#__bwpostman_campaigns` MODIFY COLUMN `title` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_campaigns` MODIFY COLUMN `description` TEXT NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_campaigns` MODIFY COLUMN `archived_by` VARCHAR(11) NOT NULL DEFAULT '0' COLLATE `utf8mb4_unicode_ci`;

ALTER TABLE `#__bwpostman_mailinglists` COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_mailinglists` MODIFY COLUMN `title` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_mailinglists` MODIFY COLUMN `description` TEXT NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_mailinglists` MODIFY COLUMN `archived_by` VARCHAR(11) NOT NULL DEFAULT '0' COLLATE `utf8mb4_unicode_ci`;

ALTER TABLE `#__bwpostman_newsletters` COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `from_name` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `from_email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `reply_email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `usergroups` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `selected_content` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `subject` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `description` TEXT NOT NULL COLLATE `utf8mb4_unicode_ci`;
...
ALTER TABLE `#__bwpostman_newsletters` MODIFY COLUMN `archived_by` VARCHAR(11) NOT NULL DEFAULT '0' COLLATE `utf8mb4_unicode_ci`;
...
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `from_name` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `from_email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `subject` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `body` LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `cc_email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `bcc_email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `attachment` TEXT NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `reply_email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailcontent` MODIFY COLUMN `reply_name` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;

ALTER TABLE `#__bwpostman_sendmailqueue` COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailqueue` MODIFY COLUMN `recipient` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailqueue` MODIFY COLUMN `name` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_sendmailqueue` MODIFY COLUMN `firstname` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;

ALTER TABLE `#__bwpostman_subscribers` COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `name` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `firstname` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `email` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `special` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `activation` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `editlink` VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `registration_ip` VARCHAR(15) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `confirmation_ip` VARCHAR(15) NOT NULL COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_subscribers` MODIFY COLUMN `archived_by` VARCHAR(11) NOT NULL DEFAULT '-1' COLLATE `utf8mb4_unicode_ci`;
...
ALTER TABLE `#__bwpostman_templates` MODIFY COLUMN `title` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
...
ALTER TABLE `#__bwpostman_templates` MODIFY COLUMN `archived_by` VARCHAR(11) NOT NULL DEFAULT '0' COLLATE `utf8mb4_unicode_ci`;

ALTER TABLE `#__bwpostman_templates_tpl` COLLATE `utf8mb4_unicode_ci`;
ALTER TABLE `#__bwpostman_templates_tpl` MODIFY COLUMN `title` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`;
