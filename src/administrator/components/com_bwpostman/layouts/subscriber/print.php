...
use BoldtWebservice\Component\BwPostman\Administrator\Model\SubscriberModel;
...
$subscriber	= $model->getSubscriberData((int) $subsId);
?>
...
<head>
	...
	<body id="preview_html">
		...
		<table>
			<tr>
				<td class="left">
					<strong><?php echo $form->getLabel('gender'); ?></strong>
				</td>
				<td>
					<?php
			...
			<tr>
				<td class="left">
					<strong><?php echo $form->getLabel('firstname'); ?></strong>
				</td>
				<td>
					<?php echo $subscriber->firstname; ?>
				</td>
			</tr>
			<tr>
				<td class="left">
					<strong><?php echo $form->getLabel('name'); ?></strong>
				</td>
				<td>
			...
			<tr>
				<td class="left">
					<strong><?php echo $form->getLabel('email'); ?></strong>
				</td>
				<td>
			...
			<tr>
				<td class="left">
					<strong><?php echo $form->getLabel('special'); ?></strong>
				</td>
				<td>
					<?php echo $subscriber->special; ?>
				</td>
			</tr>
			<tr>
				<td class="left">
				...
				<td>
					<?php echo $subscriber->emailformat; ?>
				</td>
			</tr>
			<tr>
				<td class="left">
				...
				<td>
					<?php
					if ($subscriber->status === 1 && $subscriber->archive_flag === 0)
					{
						echo mb_strtolower(Text::_('COM_BWPOSTMAN_ARC_SUB_CONFIRMED'));
					}
					elseif ($subscriber->status === 0 && $subscriber->archive_flag === 0)
					{
						echo mb_strtolower(Text::_('COM_BWPOSTMAN_ARC_SUB_UNCONFIRMED'));
					}
					elseif ($subscriber->archive_flag !== 0)
					{
		...
		<table>
			...
			if ($subscriber->registered_by != '')
			{
				...
				<tr>
					...
					<td>
						<?php echo $subscriber->registered_by; ?>
					</td>
				</tr>
				<?php
			}
			...
			<tr>
				...
				<td>
					...
					{
						echo $subscriber->confirmation_date;
					}
					else
					{
			...
			if ($subscriber->status === 1)
			{
				if ($subscriber->confirmed_by != '')
				{
					...
					<tr>
						...
						<td>
							<?php echo $subscriber->confirmed_by; ?>
						</td>
					</tr>
					<?php
				}
				...
				<tr>
					...
					<td>
						<?php echo $subscriber->confirmation_ip; ?>
					</td>
				</tr>
				<?php
			}
			if ($subscriber->modified_by != '')
			{
				...
				<tr>
					...
					<td>
						<?php echo $subscriber->modified_by; ?>
					</td>
				</tr>
				<tr>
					<td class="left">
					...
					<td>
						<?php echo $subscriber->modified_time; ?>
					</td>
				</tr>
				<?php
			}
