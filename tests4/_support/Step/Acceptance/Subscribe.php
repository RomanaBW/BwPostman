...
class Subscribe extends \AcceptanceTester
{
	...
	public function subscribeByModule(SubscriberviewPage $subscriberView, $mailaddress)
	{
		...
		$I->waitForElementVisible($subscriberView::$registration_complete, 30);
