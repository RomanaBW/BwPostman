...
docker commit -a 'Romana Boldt info@boldt-webservice.de' push4-web universe3:5000/romana/bwpm-configured-files-$PHP_VERSION:latest
docker commit -a 'Romana Boldt info@boldt-webservice.de' push4-db universe3:5000/romana/bwpm-configured-tables-$PHP_VERSION:latest
