<?php  //[STAMP] 720a824408e0e285b84bab9dcb95802e
...
trait AcceptanceTesterActions
{
     ...
     */
    public function GetListData($table_name = "mailinglists", $columns = "*", $archive = 0, $status = "", $order_col = "", $order_dir = "ASC", $limit = 20, $criteria = [], $tab = 1) {
	 ...
	 *
	 * @since   4.0.0
     * @see \Helper\Acceptance::getExtensionEnabledState()
     */
    public function getExtensionEnabledState(string $extension = "com_bwpostman"): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getExtensionEnabledState', func_get_args()));
    }
	 ...
	 *
	 * @since 2.0.0
     * @see \Helper\Acceptance::getJoomlaMainVersion()
     */
    public function getJoomlaMainVersion(\AcceptanceTester $I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getJoomlaMainVersion', func_get_args()));
    }
