 ...
 *
 * BwPostman modal bootstrap3 template for module.
 *
...
<div id="mod_bwpostman">
	...
	<button id="bwp_reg_open" type="button" class="btn btn-default">
		<?php echo Text::_(
		...
		<div id="bwp_reg_modal-content">
			...
			<div id="bwp_reg_wrapper">
				<form action="<?php echo Route::_('index.php?option=com_bwpostman&view=register'); ?>" method="post" id="bwp_mod_form"
						class="form-horizontal bs3" name="bwp_mod_form" onsubmit="return checkModRegisterForm();">
					...
					if ($paramsComponent->get('show_gender', '1') == 1)
					{
						...
						<div class="form-group bwp_mod_form_genderformat">
							<label id="gendermsg_mod" class="col-sm-4 control-label<?php echo $formclass === "sm" ? ' small' : ''; ?>">
					...
					{ // Show firstname-field only if set in basic parameters
						...
						<div id="bwp_mod_form_firstnamefield" class="form-group">
							...
							?>
							<label class="col-sm-4 control-label<?php echo $formclass === "sm" ? ' small' : ''; ?>" for="a_firstname">
					...
					if ($paramsComponent->get('show_name_field', '1') OR $paramsComponent->get('name_field_obligation', '1'))
					{
						...
						<div id="bwp_mod_form_namefield" class="form-group">
							...
							?>
							<label class="col-sm-4 control-label<?php echo $formclass === "sm" ? ' small' : ''; ?>" for="a_name">
					...
					?>
						<div id="bwp_mod_form_specialfield" class="form-group">
							...
							?>
							<label class="col-sm-4 control-label<?php echo $formclass === "sm" ? ' small' : ''; ?>" for="a_special">
					...
					<div id="bwp_mod_form_emailfield" class="form-group">
						<label  class="col-sm-4 control-label<?php echo $formclass === "sm" ? ' small' : ''; ?>" for="a_email">
					...
					if ($paramsComponent->get('show_emailformat', '1') == 1)
					{
						...
						?>
						<div id="bwp_mod_form_emailformatfield" class="form-group mb">
							<label id="emailformatmsg_mod" class="col-sm-4 control-label<?php echo $formclass === "sm" ? ' small' : ''; ?>">
					...
					{ ?>
						<div class="question well well-sm">
					...
					if ($paramsComponent->get('use_captcha', '0') == 2)
					{
						...
						<div class="captcha well well-sm">
							<div class="security_question_entry small"><?php echo Text::_('MOD_BWPOSTMANCAPTCHA'); ?></div>
					...
					<div class="mod-button-register mb">
						<button class="button btn btn-default<?php echo $formclass === "sm" ? ' btn-sm' : ''; ?>" type="submit">
